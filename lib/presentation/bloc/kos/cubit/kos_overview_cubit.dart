...
class KosOverviewCubit extends Cubit<KosOverviewState> {
  ...
  Future<void> load({required String kosId}) async {
  ...
  Future<void> settleOverdue(OverdueEntity item) async {
  ...
  KosOverviewLoaded _toLoaded(
    KosOverviewEntity overview, {
